...
HD_PWD='C:/Users/ZENG/Desktop/qyz/internship/Project/Hardware/matmul_baseline/matmul_baseline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log matrix_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source matrix_mult.tcl
